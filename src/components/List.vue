        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            >
                ...
                <template #cell(actions)="row">
                    <b-button-group>
                        <b-button size="sm" @click="info(row.item, row.index, $event.target)" squared variant="primary" class="mr-3">
                            Show Modal
                        </b-button>
                    </b-button-group>
                </template>
            ...
            <!-- Info modal -->
            <b-modal :id="infoModal.id" :title="infoModal.token.toUpperCase() + ' Price Source'" size="xl"  ok-only @hide="resetInfoModal">
